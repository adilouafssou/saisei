...
def test_bunri_clean_firm_scores_well() -> None:
    ...
    assert conditions.bunri_score == 40.0, "Clean firm should receive full bunri score (40 pts)"
...
def test_bunri_score_in_range() -> None:
    ...
    for shueki, hiyo in [
        ...
        assert 0.0 <= conditions.bunri_score <= HOSHO_WEIGHT_BUNRI, (
            f"bunri_score={conditions.bunri_score} out of range for shueki={shueki}, hiyo={hiyo}"
        )
